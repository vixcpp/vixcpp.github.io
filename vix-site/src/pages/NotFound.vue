    ...
    <div class="nf-inner">
      ...
      <div class="nf-cheetah-wrap" aria-hidden="true">
        ...
        >
          ...
          <!-- Neck -->
          <path
            d="M340 88 Q360 72 372 65 Q382 60 388 62"
            stroke="#22c55e"
            stroke-width="12"
          ...
          <path
            class="nf-tail"
            d="M185 100 Q160 90 140 98 Q120 108 115 102 Q108 95 118 88"
            stroke="#22c55e"
            stroke-width="6"
            stroke-linecap="round"
            fill="none"
          ...
          <path
            class="nf-leg-fr"
            d="M330 128 Q338 148 342 165 Q344 172 340 175"
            stroke="#22c55e"
            stroke-width="7"
            stroke-linecap="round"
            fill="none"
          ...
          <ellipse
            ...
            fill="#22c55e"
            opacity="0.8"
            transform="rotate(-10 340 176)"
          />

          <!-- Front left leg (back swing) -->
          <path
            class="nf-leg-fl"
            d="M310 128 Q305 148 300 162 Q297 170 293 172"
            stroke="#22c55e"
            stroke-width="7"
            stroke-linecap="round"
            fill="none"
          ...
          <ellipse
            ...
            fill="#22c55e"
            opacity="0.6"
            transform="rotate(5 292 173)"
          />

          <!-- Hind right leg (reaching back and under) -->
          <path
            class="nf-leg-hr"
            d="M215 130 Q208 150 210 168 Q212 176 218 178"
            stroke="#22c55e"
            stroke-width="7"
            stroke-linecap="round"
            fill="none"
          ...
          <ellipse
            ...
            fill="#22c55e"
            opacity="0.8"
            transform="rotate(-5 218 179)"
          />

          <!-- Hind left leg (extended far forward) -->
          <path
            class="nf-leg-hl"
            d="M235 125 Q250 145 268 158 Q276 165 274 170"
            stroke="#22c55e"
            stroke-width="7"
            stroke-linecap="round"
            fill="none"
      ...
      <div class="nf-text">
        ...
        <h1 class="nf-title">
          Too fast.<br /><span class="nf-title-accent">Went past it.</span>
        </h1>

        <p class="nf-desc">
          This page doesn't exist. The cheetah kept running — maybe it knew
        ...
        <div class="nf-terminal">
          ...
          <span class="nf-cmd"
            >vix run <span class="nf-path">{{ path }}</span></span
          >
          <br />
        ...
        <div class="nf-actions">
          ...
          <RouterLink to="/install" class="nf-btn-secondary"
            >Install Vix</RouterLink
          >
          <a
...
.nf-cheetah {
  width: 100%;
  height: auto;
  filter: drop-shadow(0 0 18px rgba(34, 197, 94, 0.22))
    drop-shadow(0 0 40px rgba(34, 197, 94, 0.08));
...
@keyframes cheetah-glow {
  ...
  100% {
    filter: drop-shadow(0 0 16px rgba(34, 197, 94, 0.2))
      drop-shadow(0 0 36px rgba(34, 197, 94, 0.07));
  }
  50% {
    filter: drop-shadow(0 0 24px rgba(34, 197, 94, 0.35))
      drop-shadow(0 0 52px rgba(34, 197, 94, 0.14));
  }
}
